...
var fhemWVC = {
	...
	initialize: function() {
		...
		wvcApp.initialize(function(){
			...
			fhemWVC.appId = fhemWVC.defaultAppId;
			if (typeof(window.appInterface) != 'undefined' && typeof(window.appInterface) == 'function') {
	...
	createIcons: function() {
		...
		iconDiv.innerHTML+= '<div class="batteryIconWrapper"><div id="fhemWVC_batteryIcon" class="batteryIcon bat0"><div id="fhemWVC_acConnectedIcon" class="acConnected"></div><div id="fhemWVC_batteryPercent" class="txtPercent">?%</div></div></div> </div>';
